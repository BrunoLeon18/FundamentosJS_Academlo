...
// .entries() Devuelve un array que contiene todos los pares [key, value] de las propiedades enumerables
//  en formato cadena de texto que le pertenece a un objeto dado.
...
// .fromEntries() Devuelve un objeto que contiene todos los pares [key, value] de las propiedades enumerables
//  en formato cadena de texto que le pertenece a un array dado.
const infoUser = [['name', 'Alejandra'], ['age', 15], ['lastName', 'Olazagasti']]
console.log(Object.fromEntries(infoUser))

// .assign() Asigna una o más propiedades de un objeto a un nuevo objeto destino.
const obj = {}
